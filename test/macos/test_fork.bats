...
function invoke_austin {
  ...
  # -------------------------------------------------------------------------
    ...
    assert_success
    assert_output "keep_cpu_busy (.*test/target34.py:32)"
  ...
  # -------------------------------------------------------------------------
    ...
    assert_not_output "keep_cpu_busy (.*test/target34.py:32)"
    assert_file "/tmp/austin_out.txt" "keep_cpu_busy (.*test/target34.py:32)"
